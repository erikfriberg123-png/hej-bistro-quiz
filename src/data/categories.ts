...
export const IT_CATEGORIES: Category[] = [
  ...
  {
    id: 'tools_workflow',
    name: 'Verktyg & Arbetsflöde',
    icon: '🛠️',
    color: '#00FF64',
    description: 'Git, IDE:er, agile & felsökning',
  },
  {
    id: 'tech_history',
    name: 'Teknikhistoria & Kultur',
    icon: '🏛️',
    color: '#00CC50',
    description: 'Kända företag, uppfinnare & milstolpar',
  },
  {
    id: 'fun_culture',
    name: 'Roligt & Kultur',
    icon: '😄',
    color: '#00FF64',
    description: 'Techhumor, memes & developer-liv',
  },
];
